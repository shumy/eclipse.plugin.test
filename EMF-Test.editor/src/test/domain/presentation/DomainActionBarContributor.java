 ...
 * $Id$
 */
package test.domain.presentation;
...
public class DomainActionBarContributor
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DomainEditorPlugin.INSTANCE.getString("_UI_DomainEditor_menu"), "test.domainMenuID");
