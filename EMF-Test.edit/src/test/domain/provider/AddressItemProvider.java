...
/**
 * This is the item provider adapter for a {@link test.domain.Address} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Address_local_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Address_local_feature", "_UI_Address_type"),
				 DomainPackage.Literals.ADDRESS__LOCAL,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Address)object).getLocal();
