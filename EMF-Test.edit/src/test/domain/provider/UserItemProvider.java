...
/**
 * This is the item provider adapter for a {@link test.domain.User} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.USER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_pass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_pass_feature", "_UI_User_type"),
				 DomainPackage.Literals.USER__PASS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGroupsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_User_groups_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_User_groups_feature", "_UI_User_type"),
				 DomainPackage.Literals.USER__GROUPS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.USER__ADDRESSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.USER__ADDRESSES,
				 DomainFactory.eINSTANCE.createAddress()));
	}
